...
import { createVector3Proxy, proxifyVector3 } from "../src/Vector3"
...
const stride = 3
const createVector3AoS = (n=10) => Array(n)
...
describe('Vector3', () => {
  ...
  describe('AoS', () => {
    it('should proxify existing Vector3 object to Vector3 AoS', () => {
      const id = 1
      ...
      assert(vector3AoS[id][1] === 2)
      assert(vector3AoS[id][2] === 3)

      // persists changes from object to AoS
      vector3.x = 4
      vector3.y = 5
      vector3.z = 6
      assert(vector3AoS[id][0] === 4)
      assert(vector3AoS[id][1] === 5)
      assert(vector3AoS[id][2] === 6)
